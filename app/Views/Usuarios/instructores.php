...
<head>
    ...
    <title><?= htmlspecialchars($titulo ?? 'Instructores') ?></title>
    ...
    <main class="layout layout--usuarios">
        <section class="panel panel--usuarios">
            <div class="usuarios__header">
                <h1 class="panel__title">Gestión Instructores</h1>
                <a href="/usuarios/crear?rol=instructor" class="btn btn--primary">Crear instructor</a>
            </div>
            <p class="panel__intro">Usuarios con rol instructor. Las credenciales se envían por correo al crearlos.</p>

            <?php if (empty($usuarios)): ?>
                <p class="usuarios__empty">No hay instructores registrados. <a href="/usuarios/crear?rol=instructor">Crear uno</a>.</p>
            <?php else: ?>
                            ...
                            <?php foreach ($usuarios as $u): ?>
                                <tr class="usuarios__row">
                                    ...
                                    <td class="usuarios__td usuarios__td--nombre">
                                        <i class="fas fa-chalkboard-teacher usuarios__icon"></i>
